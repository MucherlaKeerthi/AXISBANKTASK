        ...
        <center>
            ...
            <Link className= "btn btn-primary" to="/FirstPage" style={{ marginLeft:'72rem',marginTop:'3px'}}>Logout</Link>
                ...
                <tbody>
                            ...
                            <td>
                                ...
                                <button class="btn btn-outline-dark btnAdd" onClick={userButton}>Add Amount</button>
                                <button class="btn btn-outline-dark btnAdd" onClick={userButton1}>Withdraw Amount</button>
                            </td>
                            </tr>
            ...
            <Link className="btn btn-primary" to="/Welcome">Back to Home</Link> 
                ...
                <tbody>
                            ...
                            <td>
                                <button class="btn btn-outline-dark btnAdd" onClick={currentAddAmount}>Add Amount</button>
                                <button class="btn btn-outline-dark btnAdd" onClick={currentWithAmount}>Withdraw Amount</button>
                            </td>
                            </tr>
